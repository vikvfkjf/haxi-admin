<template>
  <div class="price-dialog">
    <el-dialog title="修改矿池" :visible.sync="dialogVisible" width="50%" :before-close="handleClose" center
      v-loading="loading">
      <div class="content">
...
<script>
  import {updatePool} from '@/api/pool'
  import {
    getToken
  } from '@/utils/auth'
  export default {
    ...
    methods: {
      show(val) {
        ...
        this.form = {
          id: val.id,
          mine_type  : val.mine_type,
          output : val.output,
          pledge_sum :val.pledge_sum,
          participants :val.participants,
          node_number :val.node_number,
          user_earn  :val.user_earn, 
        },
