<template>
  <div class="month-total-table">
    <div class="searchs">
      <el-form :inline="true" :model="searchForm" class="demo-form-inline" size="mini">
        <el-form-item label="日期">
          <el-date-picker v-model="searchForm.date" type="monthrange" range-separator="至" start-placeholder="开始日期"
    ...
    <div class="tables">
      <el-table :data="tableData" style="width: 100%" :header-cell-style="{background:'#ececec'}"
        ...
        <el-table-column prop="money" label="费用金额" width="400">
        </el-table-column>
